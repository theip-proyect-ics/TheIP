...
Profesor::Profesor(string nombre, string apellido, string email, bool doctorado) : Usuario(nombre, apellido, email)
{
	nGrados = 0;
	numTFGs = NULL;
	maxTFGs = NULL;
...
void Profesor::anadirGrado(int id, int maxTFG)
{
	...
	cout << "llevo ya " << nGrados << " grados" << endl;

	cout << nombre << apellidos << email << endl;
